...
function constructor() {
  ...
  var xValue = function(d) { return d; },
      ...
      x_domain, y_domain
      , width = 700         // default to some height - zeros would confuse some users
      , height = 400
      , margin = {top: 0, right: 0, bottom: 0, left: 0}         // default to zero margins
      , x_axis_title = ''
      , y_axis_title = ''
      , color = '#000'
  ;
...
//          .attr('class', 'line')
  ...
  line_chart.xColor = function(val) {
    if (!arguments.length) {
      return color;
    }
    color = val;
